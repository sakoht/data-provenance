...
class FunctionWithProvenanceSpec extends FunSpec with Matchers {
  ...
  describe("functions with provenance") {
    it("should work with raw/primitive inputs") {
      ...
      result.getOutputValue shouldEqual "1.23,1.23,1.23"

      result.getProvenanceValue shouldEqual sig
    ...
    it("should work with input values that are results with provenance") {
      ...
      val f1 = AddInts(1, 2)
      val r1 = f1.run
      r1.getOutputValue shouldEqual 3
      r1.getProvenanceValue shouldEqual f1

      r1.toString shouldEqual "(3 <- AddInts(raw(1),raw(2)))"

      val f2 = MultiplyInts(2, r1)
      val r2 = f2.run
      r2.getOutputValue shouldEqual 6
      r2.getProvenanceValue shouldEqual f2

      r2.toString shouldEqual "(6 <- MultiplyInts(raw(2),(3 <- AddInts(raw(1),raw(2)))))"
      
      r2.getProvenanceValue.inputTuple._1 shouldEqual UnknownProvenance(2)
      r2.getProvenanceValue.inputTuple._2 shouldEqual r1

      r2.getProvenanceValue.inputTuple._1.resolve.getOutputValue shouldEqual 2
      r2.getProvenanceValue.inputTuple._1.resolve.getProvenanceValue shouldEqual UnknownProvenance(2)

      r2.getProvenanceValue.inputTuple._2.resolve.getOutputValue shouldEqual 3
      r2.getProvenanceValue.inputTuple._2.resolve.getProvenanceValue shouldEqual f1

      r2.getProvenanceValue.inputTuple._2.resolve.getProvenanceValue shouldEqual f1

      val f3 = AddInts(r1, r2)
      val r3 = f3.run
      r3.getOutputValue shouldEqual 9
      r3.getProvenanceValue.inputTuple._1 shouldEqual r1
      r3.getProvenanceValue.inputTuple._2 shouldEqual r2
    ...
    it("should work with nested signatures that are never called until the end") {
      ...
      val r3 = f3.run
      r3.getOutputValue shouldEqual 15
      r3.getProvenanceValue shouldEqual f3
      r3.getProvenanceValue.inputTuple._1 shouldEqual f1
      r3.getProvenanceValue.inputTuple._2 shouldEqual f2

...
from the resolution of: `com.cibo.provenance.Add(1, 2)`
take from: `test/resources/expected-output/scala-2.12/rerun1.manifest`
```
...
#### Concepts:
(TODO: Explain the bullet-list at the top.)
